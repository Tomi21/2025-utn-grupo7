...
export const products = [
  {
    ...
    images: [require("../assets/images/pizza-margarita-v2.jpg"),require("../assets/images/pizza-margarita-v2.jpg"),require("../assets/images/pizza-margarita-v2.jpg")],
  ...
  },
  {
    ...
    images: [require("../assets/images/ensalada-cesar-v4.jpg"),require("../assets/images/ensalada-cesar-v4.jpg"),require("../assets/images/ensalada-cesar-v4.jpg")],
  ...
  },
  {
    ...
    images: [require("../assets/images/bakery-v4.jpg"),require("../assets/images/bakery-v4.jpg"),require("../assets/images/bakery-v4.jpg")],
